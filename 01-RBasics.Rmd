...
To sign up visit https://rstudio.cloud/plans/free.
...
save the population number ^[Population data from https://www.census.gov/quickfacts/MD] to an object. We will call it `md_pop`
...
Next, we want to know what percentage of people in Maryland been
fully vaccinated for COVID-19. As of late July 2022, 4.68 million people of all ages have been fully vaccinated in
Maryland ^[Vaccination data from https://coronavirus.maryland.gov/#Vaccine]. Let's save that number in an object.
...
You can also assign to a specific element of a vector. Looking over our list, we realize we mispelled John's name. Let's fix that now.
