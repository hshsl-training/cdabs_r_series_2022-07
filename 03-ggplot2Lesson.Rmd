...
Facets let you split your graph into multiple smaller graphs arranged in a grid layout. This sort of visualization is often called "small multiples", and is often a useful way of reducing visual clutter. Let's use facetting to make small maps that let us compare measles rates in the five years prior to the vaccine being introduced.
