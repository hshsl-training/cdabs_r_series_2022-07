...
### Creating an RStudio Cloud project{#createRprojCloud}
...
knitr::include_graphics("images/session3/Screen Shot 2022-07-28 at 12.09.31 AM.png")
```
...
2. Checking out a project from a version control remote repository 

3. Connecting RStudio to Github

4. Set up a personal access token on Github
...
In RStudio Cloud, start a new Project [review here](#createRprojCloud):

* RStudioCloud > New Project > New Project from Git Repository. In “Repository URL”, paste the URL of your new GitHub repository. It will be something like this `https://github.com/j-p-courneya/cdabsR_Session4_Practice.git`.
...
* Accept the default project directory name, e.g. cdabsR_Session4_Practice, which coincides with the GitHub repo name.
