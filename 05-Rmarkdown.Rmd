...
library(knitr)
knitr::include_graphics("images/session3/session3_slide03.jpg")
```
...
```{r echo=F, out.width = '80%', fig.align="center"}
library(knitr)
knitr::include_graphics("images/session3/rmd_introduction.jpg")
```
...
```{r echo=F, out.width = '80%', fig.align="center"}
library(knitr)
knitr::include_graphics("images/session3/rmd_related-pkgs.jpg")
```
...
```{r echo=F, out.width = '80%', fig.align="center"}
knitr::include_graphics("images/session3/create_rmd.png")
```
...
knitr::include_graphics("images/session3/run_code_chunk.png")
```

To generate a report from the file, use the ![](images/session3/knit_button.png){width="62"} button in the RStudio IDE to render the file and preview the output with a single click or keyboard shortcut (⇧⌘K).You will notice your first time "knitting" the document you are prompted to save the file, save it with a meaningful name, like `Rmarkdown-practice.Rmd`.

```{r echo=F, out.width = '100%', fig.align="center"}
knitr::include_graphics("images/rmd_render.png")
```

Or, in the console, run the `render` command:

```{r eval=FALSE}
library(rmarkdown)
render("Rmarkdown-practice.Rmd")
```
...
```{r echo=F, out.width = '100%', fig.align="center"}
knitr::include_graphics("images/session3/rmarkdownflow.png")
```

When you run `render`, or press the ![](images/session3/knit_button.png){width="62"} button, R Markdown feeds the .Rmd file to knitr, which executes all of the code chunks and creates a new markdown (.md) document which includes the code and its output.

The markdown file generated by knitr is then processed by pandoc which is responsible for creating the finished format.

This may sound complicated, but R Markdown makes it extremely simple by encapsulating all of the above processing into a single `render` function or ![](images/session3/knit_button.png){width="62"} button.
...
knitr::include_graphics("images/session3/rmd_headers.png")
```
...
As a courtesy, here is the code to copy and place in chunks: 
```{r eval=FALSE}
download.file("https://raw.githubusercontent.com/swcarpentry/r-novice-gapminder/gh-pages/_episodes_rmd/data/gapminder_data.csv", destfile = "data/gapminder_data.csv")
